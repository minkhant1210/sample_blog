    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">
                                <i class="feather-list text-primary mr-1"></i>Items Lists
                            </h4>
                            <div class="">
                                <a class="btn btn-sm btn-outline-primary" id="full-page-btn" href="#"><i class="feather-maximize-2"></i></a>
                                <a class="btn btn-sm btn-outline-primary" href="<?php echo $url ?>/item_add.php"><i class="feather-plus-circle"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table id="list" class="table table-striped table-responsive-sm" style="width:100%">
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th>Position</th>
